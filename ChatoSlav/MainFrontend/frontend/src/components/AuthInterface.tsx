    ...
    <div className="flex-1 p-8 bg-site min-h-full">
      <div className="max-w-md mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-primary">Присоединяйтесь к нашему православному сообществу</p>
        </div>
        ...
        >
          <CardContent className="p-4">
            <div className="text-center text-primary">
              <h3 className="font-medium mb-2 text-primary-heading">Присоединяйтесь к нашему сообществу</h3>
              <p className="text-sm leading-relaxed">
                Присоединившись к нашему православному сообществу, вы получаете доступ к духовному руководству, 
                участвуете в обсуждениях и вносите вклад в общий фонд, который помогает другим искать 
                божественную мудрость. Да благословит Бог ваш путь.
              </p>
            </div>
          </CardContent>
        </Card>
