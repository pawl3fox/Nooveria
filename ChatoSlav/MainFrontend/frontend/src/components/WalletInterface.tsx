...
export function WalletInterface({ user }: WalletInterfaceProps) {
  ...
  const transactions = [
    { type: "received", amount: 50, description: "Пожертвование сообщества", date: "2 часа назад" },
    { type: "spent", amount: 25, description: "Разговор в чате", date: "1 день назад" },
    { type: "received", amount: 100, description: "Покупка токенов", date: "3 дня назад" },
    { type: "spent", amount: 15, description: "Молитвенная просьба", date: "5 дней назад" },
    { type: "received", amount: 75, description: "Возврат токенов", date: "1 неделю назад" },
    { type: "spent", amount: 30, description: "Консультация", date: "2 недели назад" },
  ];
    ...
    <div className="flex-1 p-8 bg-site min-h-full">
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl text-primary-heading mb-2">Духовный кошелёк</h1>
          ...
          <div className="lg:col-span-2">
            ...
            >
              <CardHeader className="text-center pb-4">
                ...
                <CardDescription className="text-base text-secondary">Ваши доступные токены для духовных бесед</CardDescription>
              </CardHeader>
              <CardContent className="text-center pb-8">
                <div className="mb-8">
                  <div className="text-7xl font-light text-primary-heading mb-2">{loading ? '...' : (user?.personal_wallet_balance || 0)}</div>
                ...
                >
                  ...
                  <CardContent className="text-center">
                    ...
                    <p className="text-xs text-secondary">
                      Помогите другим получить духовное руководство
                    </p>
                  </CardContent>
                </Card>
              </TabsContent>
              ...
              <TabsContent value="stats" className="mt-4">
                ...
                >
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex justify-between items-center py-2">
                      <span className="text-sm text-primary">Пожертвований</span>
                  ...
                  {transactions.map((transaction, index) => (
                    <div key={index} className="flex items-center justify-between py-3 border-b border-accent/30 last:border-b-0">
                      ...
                      <Badge 
                        ...
                        className={transaction.type === 'received' 
          ...
          <CardContent className="p-6">
            <div className="text-center text-primary">
              ...
              <p className="text-sm leading-relaxed">
                Токены используются для доступа к услугам православного чат-бота. Вы можете покупать токены 
                для личного использования или вносить в общий фонд, чтобы помочь другим членам сообщества 
                получить духовное руководство. Каждый разговор стоит небольшое количество токенов для поддержания сервиса.
              </p>
            </div>
          </CardContent>
        </Card>
